# train_vgg19.py
"""
Train a pretrained VGG19 (with BatchNorm) model on the fruit dataset located in ./train
...
if __name__ == "__main__":
    ...
    optimizer = torch.optim.SGD(filter(lambda p: p.requires_grad, model.parameters()),
                                lr=8e-4, momentum=0.9, weight_decay=5e-4)
    ...
    torch.save(model.state_dict(), "fruit_vgg19_pretrained.pth")
    print("\n✅ Training complete! Model saved to fruit_vgg19_pretrained.pth")
